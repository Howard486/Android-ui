...
android {
    namespace = "com.foldspace.launcher"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.foldspace.launcher"
        // Private Space (V1.0) needs 35, but the V0.1 launcher core runs from 30.
        minSdk = 30
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
    ...
    buildTypes {
        debug {
            // Suffixed so FoldSpace debug can be installed next to a release
            // build while testing the ROLE_HOME hand-over.
        ...
        release {
            ...
            // Debug-signed so CI can produce an installable APK without secrets.
